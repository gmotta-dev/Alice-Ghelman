...
export default function MobileAnchors() {
  ...
  return (
    <Fragment>
      ...
      <ContentWrapper
        element="div"
        className={`flex lg:hidden ${expandNav ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-4 opacity-0"} absolute left-1/2 top-[140%] z-50 w-[93%] -translate-x-1/2 flex-col items-center justify-center gap-4 rounded-lg bg-nandor-600 py-6 transition-all duration-300`}>
