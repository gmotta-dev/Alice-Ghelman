...
const Text = () => {
  return (
    <div className="flex w-full max-w-[704px] flex-col gap-4 rounded-2xl bg-loafer-100 p-8 font-inter text-sm text-loafer-900 md:text-base">
      ...
      <p> Psicóloga formada pela PUC-Rio (CRP 05/73768) na metade de 2023. Atuante na área desde 2020.</p>
      ...
      <p>
        Sou uma mulher-cis, brasileira e carioca, que ama a cor verde, os livros, a vida e tudo que ela inclui. No final, sou uma artista, psicóloga, psicanalista e pessoa em
        constante formação.
      </p>
    </div>
  );
