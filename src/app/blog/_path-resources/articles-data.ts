...
export const articlesData: TArticle[] = [
  {
    slug: "pessoas-atipicas",
    title: "O que é ser atípico?",
    title_lg: "O que é ser atípico? Entendendo a diversidade humana",
...
Antes de complicar, vamos aos fatos: toda pessoa diferente é considerada atípica. Logo, as pessoas que tem algum tipo de diagnóstico, transtorno psicológico ou deficiência física são consideradas pessoas atípicas. 

Na psicologia é muito comum usarem esses termos para se referirem a pessoas com autismo, mas não somente elas. Pessoas com outros transtornos também podem ser incluídas, principalmente os transtornos que apresentam delírios e formas de ser que não condizem com o restante da sociedade. 

Isso porque é ela, a sociedade, que dita o que é normal e o que é diferente, atípico e, consequentemente, marginalizado. 

Nesse sentido, quando falamos de pessoas atípicas, sejam elas crianças, adolescentes ou adultos, estamos falando de pessoas que, por algum motivo, não seguem os padrões de funcionamento mental estabelecidos pela coletividade.

Esses podem ser os indivíduos com esquizofrenia, com transtornos de humor, como bipolaridade, com transtornos de personalidade, como o dissocitativo de identidade, com atrasos no desenvolvimento cognitivo, com dislexia, mutismo, autismo e todos os outros quadros em que a pessoa não seja considerada "normal". 
...
Portanto, nada melhor do que ir de encontro às nossas partes que não são tão normais assim e conviver com elas da maneira mais equilibrada possível. 
  ...
  {
    slug: "crianca-faz-terapia",
    title: "Criança faz terapia?",
    title_lg: "Criança faz terapia? Entendendo as necessidades das crianças",
